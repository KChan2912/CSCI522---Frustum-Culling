...
struct CameraSceneNode : public SceneNode
{
	...
	Matrix4x4 m_viewToProjectedTransform;
	Vector3 TopPlane, BotPlane, LeftPlane, RightPlane, pos, NearPlane, FarPlane, farCenter, nearCenter;//FrustumRelatedVars


	float m_near, m_far;//FrustumRelatedVars
};
}; // namespace Components
}; // namespace PE
#endif
